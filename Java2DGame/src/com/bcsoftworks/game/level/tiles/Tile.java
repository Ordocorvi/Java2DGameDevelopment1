...
public abstract class Tile {
	...
	public static final Tile SAND = new BasicTile(4, 3, 0, Colors.get(-1, 542, 552, -1), 0xFFFFE363);
	...
	public abstract void render(Screen screen, Level level, int tile, int color);
